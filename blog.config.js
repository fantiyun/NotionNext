...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'cd51841120a048dea0248c76a16ea042',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://fantiyun.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 前端, 开发, React, Vue, 数据结构, 算法, 建站', // 网站关键词 英文逗号隔开
